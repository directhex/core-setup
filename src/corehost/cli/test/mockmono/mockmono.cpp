    ...
    unsigned int* domainId)
{
    ...
    {
        *hostHandle = reinterpret_cast<mono_t::host_handle_t>(0xdeadbeef);
    }
...
struct MockMonoDelegate
{
    ...
    MockMonoDelegate(mono_t::host_handle_t hostHandle,
                        unsigned int domainId,
    ...
    mono_t::host_handle_t m_hostHandle;
...
static MockMonoDelegate DelegateState[MaxDelegates];
    ...
    void** delegate)
{
    ...
    MockMonoDelegate delegateState(hostHandle, domainId, entryPointAssemblyName, entryPointTypeName, entryPointMethodName);
